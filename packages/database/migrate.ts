...
await mkdir('packages/database/migrations',{recursive:true}); await writeFile('packages/database/migrations/0001_initial.sql',sql); console.log('migration written packages/database/migrations/0001_initial.sql');
